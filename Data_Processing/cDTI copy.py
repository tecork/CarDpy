def cDTI_recon(myocardial_mask, Eigenvectors, num_interp_points = 200, smoothness_level = 'Low', helix_angle_outlier_criteria = 1):
    ...
    from   cardpy.Tools.Contours       import Myocardial_Mask_Contour_Extractor, Angular_Contour_Organization
    from   cardpy.Tools.Contours       import Countour_BSpline, Myocardial_Mask_Contour_Filler
...
def Spatial_Helix_Angle_Filtering(helix_angle, mask, wall_depth_factor = 0.25, kernel_size = 5):
    from   cardpy.Tools.Contours import Myocardial_Mask_Contour_Extractor, Comprehensive_Outter_Contour, Moving_Window_2D
    import math
    import pandas as pd
